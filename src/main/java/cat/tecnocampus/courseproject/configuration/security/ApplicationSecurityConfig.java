...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //Customer and admin
                .antMatchers("/api/customers/me", "api/orders/delete/**", "/api/products", "/api/subscriptions/me", "api/customers/orders/me").hasAnyRole("CUSTOMER, ADMIN")
                .antMatchers(HttpMethod.POST, "/api/subscription").hasAnyRole("CUSTOMER, ADMIN")
                .antMatchers(HttpMethod.POST, "api/orders/update/**").hasAnyRole("CUSTOMER, ADMIN")
